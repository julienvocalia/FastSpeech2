...
from TTS.tts.models.fastalign_tts import FastAlignTTSArgs
...
class FastAlignConfig(BaseTTSConfig):
    ...
    model: str = "fastalign"
    base_model: str = "fastalign_tts"

    # model specific params
    model_args: FastAlignTTSArgs = FastAlignTTSArgs(use_pitch=True, use_energy=True)
